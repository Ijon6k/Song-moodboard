<script>
  ...
  import { openUpload } from '$lib/stores/ui.js';
  ...
  <section id="catalog" class="max-w-7xl mx-auto px-6 py-16">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-5 mb-10 pb-5 border-b border-calm-border">
      <div>
        ...
        <p class="text-xs sm:text-sm text-calm-muted mt-1">Select any soundscape to immerse in its visual moodboard fragments and audio.</p>
      </div>
